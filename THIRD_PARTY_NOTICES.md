...
- Use: optional image processing support for effects and analysis.
...
- Use: application runtime and desktop user interface.
- License: Python Software Foundation License and Tcl/Tk license terms.
- Source: https://www.python.org/
- License: https://docs.python.org/3/license.html

## PyInstaller

- Use: packaging helper for the standalone Windows executable.
